...
There is not a single approach to design APIs “the right way.” Instead, we need to lean on industry basic API design guidelines, best practises and patterns where relevant, then take cues from those who will use our APIs.
