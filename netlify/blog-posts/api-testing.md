...
![Create an API specification in Stoplight](https://cdn-images-1.medium.com/max/800/0*cvftwMv_Scx1ag73.)
...
![Stoplight Classic Visual Editor](https://cdn-images-1.medium.com/max/800/0*N2pvMEAdZdVU9sor.)
...
![Give Your Collection A Name](https://cdn-images-1.medium.com/max/800/0*FwgCF--OLbapskU_.)
...
![API Host](https://cdn-images-1.medium.com/max/800/0*53BODTHr7yrpaZnW.)
...
![Name of Property](https://cdn-images-1.medium.com/max/800/0*BeqGBYd1smQ8uRMD.)

Perfect! We are all set to run our tests. Click **Run Scenario** and watch your tests pass.

![Scenarios Tests](https://cdn-images-1.medium.com/max/800/0*t8dBL7bgJ8aoabLW.)
